...
class GeneralBuffAssets: 
	...
	# description 
	I_OPEN_YELLOW = RuleImage(roi_front=(774,299,6,13), roi_back=(766,133,35,366), threshold=0.6, method="Template matching", file="./tasks/Component/GeneralBuff/gb/gb_open_yellow.png")
	# description 
	I_CLOSE_RED = RuleImage(roi_front=(773,365,6,16), roi_back=(764,134,38,369), threshold=0.6, method="Template matching", file="./tasks/Component/GeneralBuff/gb/gb_close_red.png")
	# 用来判定是否点击的那个 
